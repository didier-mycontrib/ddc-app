...
export class AdminRessourcesComponent implements OnInit, GenericCrudAbstractContextHelper<Ressource> {
  ...
  public resCategoriesSelectionnables = [ "ressource" , "plan" , "cv" , "illustration" , "avis" , "autres"];
   ...
   public genericCrudContext : GenericCrudContext<Ressource> ;
...
//begin of implementation of methods of 
  ...
  onSupprimerObject(): void {
    this._ressourceService.deleteEntityObjectServerSide(this.genericCrudContext.selectedObject?.id)
 ...
 uploadData(){
  ...
  formData.append('resFile' , this.fileToUpload as any); //may be null
      ...
      .subscribe(
        sentRessource => { console.log("sent ressource:" + JSON.stringify(sentRessource));
                             ...
                             if(this.genericCrudContext.selectedObject!=null && this.genericCrudContext.selectedObject.id==null){
                                this.genericCrudContext.selectedObject.id = sentRessource.id;
                             }
